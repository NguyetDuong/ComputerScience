...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;; Question A3: Implementation of spoul-hall-exit by Person A
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(define (exit count) (sproul-hall-exit count))

(define (sproul-hall-exit count)
		(lambda ()
			(if (< count 3)
				(begin 
					(set! count (+ count 1))
...
(ask s-h 'add-exit-procedure (exit 0)) ;; A3 -- revised add-exit-procedure by Person A
